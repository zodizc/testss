...
*/
		...
		stage('Deploy to SandBox') {
			if (isUnix()) {
				...
				try{
					deployResult = bat returnStdout: true, script: "${toolbelt} force:apex:test:run -l RunAllTestsInOrg -u mafarouq@leyton.com.isoprod2 -c -r human -d C:\\Users\\mafarouq\\Desktop\\testReport5"
