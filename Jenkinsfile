                    ...
                    script {
                        if (isUnix()) {
                            try{
                                ...
                                testres = sh (returnStdout: true, script:"${env.toolbelt} force:apex:test:run --targetusername HubOrg --wait 10 -l RunAllTestsInOrg -c -r human -d \"C:\\Users\\mafarouq\\Desktop\\testReport\"")
                            }catch(err){
                                //Delete Scratch org
                             ...
                             try{
                                //Run tests in scratch org
                                testres = bat (returnStdout: true, script:"${env.toolbelt} force:apex:test:run --targetusername SandBox --wait 10 -l RunAllTestsInOrg -c -r human -d \"C:\\Users\\mafarouq\\Desktop\"")
                            }catch(err){
                                //Delete Scratch org
